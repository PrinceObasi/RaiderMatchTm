-- Add confirmation tracking to application_clicks table
ALTER TABLE application_clicks ADD COLUMN confirmed BOOLEAN DEFAULT FALSE;
ALTER TABLE application_clicks ADD COLUMN confirmation_date TIMESTAMP WITH TIME ZONE;

-- Create function to confirm application and move to applications table
